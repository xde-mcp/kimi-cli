...
use kagent::wire::{
    ...
    StatusUpdate, StepBegin, StepInterrupted, SubagentEvent, ToolCallRequest, TurnBegin, UserInput,
    WireMessage, WireMessageEnvelope, WireMessageRecord, deserialize_wire_message, is_event,
    is_request, is_wire_message, serialize_wire_message,
};
